...
<div class="ligne-bleu" style="background-color: orange;"></div>
    <div class="cards">
        ...
        <div class="card" style="background-image: url('application.jpg'); background-size: cover; background-position: center; min-height: 320px;"></div>
...
🟠 Application Mobile = Votre solution mobile</p>
   ...
   <div class="card" style="background: linear-gradient(135deg, #2980b9 0%, #3498db 40%, #ff9800 75%, #ff6b00 100%); text-align: left;">
